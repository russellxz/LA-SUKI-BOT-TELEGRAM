...
| `.mute` / `.unmute` | Silencia, admite tiempo: `.mute @user 30m` (se levanta solo al cumplirse) |
| `.daradmins` / `.quitaradmins` | Da o quita administrador |
| `.antilink on/off` | Borra invitaciones a otros grupos (Telegram, WhatsApp y Discord) |
...
| `.trag2 <n\|all>` | Migra un `guar2.json` con el formato de otro bot |
